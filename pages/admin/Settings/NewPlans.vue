<template>
    <div>
        <div class="w-full mx-auto">
            <p
                class="text-lg font-bold font-primary border-b border-lightBlue text-white"
            >
                Planes
            </p>
            <div
                v-if="isEditing"
                class="w-full flex justify-end items-center my-3"
            >
                <button
                    @click="createNewPlan"
            ...
            <div class="border border-lightBlue rounded-lg mt-6 p-6">
                ...
                <div
                    v-if="isOpen"
                    class="w-full flex flex-col justify-start mt-6"
                >
                    <div
                        class="w-full flex flex-wrap justify-between items-center pl-1"
                    >
                        <div
                            class="w-full lg:w-2/5 flex justify-start items-center"
                        >
                        ...
                        <div
                            class="w-full sm:w-1/2 lg:w-1/5 flex justify-start items-center mt-2 lg:mt-0"
                        >
                            <label class="text-white font-primary text-lg mr-1"
                                >Precio:
                            </label>
        ...
        <p
            ...
            class="font-primary text-white text-3xl w-full text-center mt-4 font-extralight"
        >
