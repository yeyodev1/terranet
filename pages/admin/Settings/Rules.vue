<template>
    <app-layout>
                ...
                >
                    ...
                    <div class="w-full flex justify-start items-start mt-6">
                        ...
                        <input
                            ...
                            type="text"
                            class="text-white outline-none border-b border-lightBlue px-1 bg-appBackground w-full"
                        />
                    </div>
                </div>
                <button
        ...
        <div
            ...
            class="w-full flex flex-col justify-center items-center mt-4 p-4 border border-lightBlue"
        >
            <div
            ...
            >
                <p class="text-white text-sm text-left break-normal">
                    {{ rule.name }}
                </p>
