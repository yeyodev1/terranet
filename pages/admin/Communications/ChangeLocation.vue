          ...
          <div class="w-full flex flex-col">
            ...
            <div class="w-full flex flex-col items-start mt-2">
              <div class="w-full flex justify-start items-center mb-2">
                <p class="text-white font-bold mr-2">Dirección actual:</p>
                <p class="text-white font-light mr-2">
                  {{ owner.address1 }}
                </p>
              </div>
              <div class="w-full flex justify-start items-center mb-2">
                <p class="text-white font-bold mr-2">Nueva dirección:</p>
                <p class="text-white font-light mr-2">
                  {{ owner.address2 }}
                </p>
              </div>
              ...
              >
                <p class="text-white font-bold mr-2">Ubicación GPS:</p>
                <p class="text-white font-light mr-2">
              ...
              <div class="w-full flex justify-start items-center mb-2">
                <p class="text-white font-bold mr-2">Referencia:</p>
                <p class="text-white font-light mr-2">
                  {{ owner.reference }}
                </p>
              </div>
