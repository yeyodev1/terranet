    ...
    <app-layout>
        ...
        <div class="my-2 w-full flex flex-col justify-between items-start">
            <div class="flex justify-center items-center">
                ...
                <div
                    class="w-40 border border-yellow rounded-lg mr-2 px-2 py-1"
                >
                    <input
                        v-model="ci"
                ...
                <button
                    class="w-8 h-8 p-1 flex justify-center items-center bg-yellow rounded-md"
                    @click="searchByCi(ci)"
                >
            ...
            <div class="flex flex-col justify-center items-start mt-2">
                <button
                    class="relative p-1 border border-lightBlue rounded-lg flex items-center w-full max-w-xs"
                >
            ...
            <button
                class="flex mt-2 justify-center items-center bg-yellow py-1 px-2 rounded-md"
            ...
            <table class="w-full rounded-lg">
                ...
                <tbody v-if="!Object.keys(getCustomerResult).length">
                    ...
                    >
                        ...
                        <th
                            class="text-white text-sm font-light py-3 px-1 hidden md:table-cell"
                        >
                            {{ customer.names }} {{ customer.lastNames }}
                        </th>
                        <th
                            class="text-white text-sm font-light py-3 px-1 hidden lg:table-cell"
                        >
                ...
                <tbody v-else>
                    <tr class="mb-4">
                        ...
                        <th
                            class="text-white text-sm font-light py-3 px-1 hidden md:table-cell"
                        >
                            {{ getCustomerResult.names }}
                            {{ getCustomerResult.lastNames }}
                        </th>
                        <th
                            class="text-white text-sm font-light py-3 px-1 hidden lg:table-cell"
                        >
        ...
        >
            <button
                class="w-8 h-8 mr-2 flex justify-center items-center rounded-lg shadow-md"
                :class="{
            ...
            <div
                class="w-8 h-8 bg-yellow mr-2 flex justify-center items-center shadow-md rounded-lg"
            >
