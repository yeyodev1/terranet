<template>
    <div class="relative flex flex-col items-center">
        <div
            class="flex flex-col items-center justify-center w-full rounded-md background-plans"
        >
            <p
                class="px-8 pt-10 text-5xl text-center font-secondary text-yellow whitespace-nowrap"
            >
                {{ homePlan.planName }}
            </p>
            <div class="flex pt-3">
                ...
                <div class="flex flex-col items-start justify-start">
                    <p
                        class="text-white font-principal font-extrabold text-2xl"
                    >
                        .{{ getCents }}
                    </p>
