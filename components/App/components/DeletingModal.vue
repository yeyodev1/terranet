<template>
    ...
    >
        <layout-background />
        <div
            class="relative top-64 left-1/3 w-1/3 h-72 rounded-lg z-20 p-4 bg-appBackground opacity-100"
        >
            <div class="w-full h-64 flex flex-col">
                ...
                <div
                    class="w-full h-60 flex flex-col justify-between pt-16 pb-10 px-3 items-end"
                >
                    <p class="w-full text-white text-center font-bold">
                        ¿Deseas eliminar el mensaje del cliente?
                    </p>
                    <button
                        class="rounded-md py-1 px-2 bg-yellow text-appBackground"
                        @click="confirming()"
                    >
                        Sí, eliminar
                    </button>
